...
unsigned char LCD_ShowFloatNum(u16 x, u16 y,float number,u8 scale, u8 size,u8 mode);//显示浮点数
void LCD_ShowChinese(u16 x, u16  y, u8 g[2]);//显示汉字
void LCD_PutString(u16 x , u16 y,char *s, u8 size );//中英文字符串显示
